...
- Если только имя/фамилия — запиши ТОЧНО то имя что написано в сообщении в full_name, не заменяй на имена из списка сотрудников
- Список сотрудников используй ТОЛЬКО для увольнений — чтобы найти кого увольняют
- Для найма: full_name = имя нового сотрудника из текста, НЕ из списка
